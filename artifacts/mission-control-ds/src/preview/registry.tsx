...
import { BentoDashboardDemo } from './demos/bento-dashboard';
...
export const DESIGN_SYSTEM = {
  ...
  description:
    'Dark-first, monospace terminal aesthetic with a neon ops palette. Extracted from the Mission Control bento dashboard. Built for data-dense AP dashboards, ops tooling, and monitoring surfaces.',
} as const;
...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    entries: [
      {
        id: 'applied-bento-dashboard',
        name: 'Bento dashboard',
        description: 'Mission Control bento grid — the source layout that defines this design system.',
        Page: BentoDashboardDemo,
      },
    ],
  },
];
