# Consuming Mission Control Design System in web apps

Read `artifacts/mission-control-ds/docs/AGENTS.md` first. This guide covers
...
`artifacts/mission-control-ds/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/mission-control-ds/styles.css";
```
...
`node_modules/@workspace/mission-control-ds/src/components` to `content`.
...
import { cn } from "@workspace/mission-control-ds/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/mission-control-ds/hooks/use-toast";
```
...
`@workspace/mission-control-ds/components/ui/button`. Run the app's typecheck
