# Migrating web UI to Mission Control Design System

Read `artifacts/mission-control-ds/docs/AGENTS.md` and
`artifacts/mission-control-ds/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/mission-control-ds/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/mission-control-ds/lib/utils`
- `@/hooks/use-toast` → `@workspace/mission-control-ds/hooks/use-toast`
