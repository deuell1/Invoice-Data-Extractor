# Consuming Mission Control Design System in Expo apps

Read `artifacts/mission-control-ds/docs/AGENTS.md` first. React Native does
...
`artifacts/mission-control-ds/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/mission-control-ds/tokens";
...
```tsx
import { nativeTheme } from "@workspace/mission-control-ds/lib/native-theme";
import { useColors } from "@workspace/mission-control-ds/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/mission-control-ds/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/mission-control-ds/components/native/badge";
import { Button } from "@workspace/mission-control-ds/components/native/button";
import { Card } from "@workspace/mission-control-ds/components/native/card";
```
...
Import and render
`@workspace/mission-control-ds/components/native/button`, then run Expo
