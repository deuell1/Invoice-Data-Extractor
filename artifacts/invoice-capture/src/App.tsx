...
const clerkAppearance = {
  ...
  variables: {
    ...
    colorDanger: "hsl(11 90% 68%)",           /* #f78166 destructive */
    colorBackground: "hsl(227 24% 7%)",        /* #0e1017 card */
    colorInput: "hsl(235 14% 16%)",            /* #242530 input */
    colorInputForeground: "hsl(0 0% 98%)",     /* #fafafa foreground */
    colorNeutral: "hsl(235 14% 16%)",
    fontFamily: "'JetBrains Mono', monospace",
    borderRadius: "0.25rem",
  },
  elements: {
    rootBox: "w-full flex justify-center",
    cardBox: "bg-card rounded-lg w-[440px] max-w-full overflow-hidden shadow-xl border border-border",
