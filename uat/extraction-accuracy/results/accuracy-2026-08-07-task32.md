...
- Ground-truth file: `ground-truth.csv`
...
|---|---|---|---|---|
| TP-001 | vendorRawName | Automation Direct | AutomationDirect.com, Inc. | INCORRECT |
...
| TP-002 | (no extracted invoice matched) |  |  | MISSING |
...
| TP-005 | vendorRawName | BDI | BDI - Princeton | INCORRECT |
...
| Incorrect fields | 3 |
| Missing fields | 9 |
| Manual corrections required | 12 |
| **Overall extraction accuracy** | **75.5%** |
| Vendor name accuracy | 20.0% |
| Invoice number accuracy | 80.0% |
| Date accuracy | 80.0% |
| Amount accuracy | 80.0% |
| PO accuracy | 100.0% |
| Currency accuracy | 80.0% |

## Verdict

**Phase 1 extraction accuracy: FAIL** (75.5% vs 95% threshold).
