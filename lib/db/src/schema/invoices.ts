...
export const invoiceCaptureTable = pgTable("invoice_capture", {
  ...
  otherChargesAmount: numeric("other_charges_amount", { precision: 18, scale: 2 }),
  tieOutExpectedTotal: numeric("tie_out_expected_total", { precision: 18, scale: 2 }),
  tieOutDifference: numeric("tie_out_difference", { precision: 18, scale: 2 }),
